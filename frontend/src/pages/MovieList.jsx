...
function MovieList() {
  ...
  //   axios
  //     .get(
  //       `https://api.themoviedb.org/3/discover/movie?sort_by=vote_average.${sortBy}&api_key=3fd2be6f0c70a2a598f084ddfb75487c&page=1`
  //     )
  //     .then((response) => {
  //       setData(response.data.results);
  //       console.log(response.data.results);
        ...
        <div className="filter">
          ...
          <ul>
            ...
            <li>
              ...
              >
                {sortBy === "desc"
                  ? "Trier par Vote (Descendant)"
                  : "Trier par Vote (Ascendant)"}
              </button> */}
            </li>
          </ul>
        </div>
